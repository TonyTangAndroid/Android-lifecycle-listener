...
/**
 * @author Jose.Han DATE 2019/4/28 0028
 *     <p>场景条件1：解决匿名内部类内存泄漏的问题，匿名内部类是纯接口，无法用静态内部类+弱引用的方式解决。 场景条件2：在没有遵循MVP模式的地方 使用条件：drop 和 isnull
 *     需要成对出现，防止抛出NullPointException
 */
